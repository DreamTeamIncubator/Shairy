...
import {profileAPI, useGetProfileQuery, useUploadAvatarMutation} from '@/features/profile/api/profileApi';
    ...
    const {getRootProps, getInputProps} = useDropzone({
        ...
        onDrop: (acceptedFiles, rejectedFiles) => {
            if (acceptedFiles.length > 0) {
                setAvatar(Object.assign(acceptedFiles[0], {preview: URL.createObjectURL(acceptedFiles[0])}))
                setError(null);
                setStep(2)
        ...
        <>
            ...
            {step === 2 && avatar &&
                <div className={style.uploadSection}>
                    ...
                    <Button variant={'primary'} onClick={saveAvatarHandler}>Save</Button>
                </div>
            }
