...
const SignUp = () => {
    ...
    return (
        <div className={s.container}>
                    ...
                    <div className={s.inputGroup}>
                        ...
                        <Input
                            ...
                            {...register('passwordConfirmation', {
                                ...
                                validate: (value: string) => value === watch('password') || 'The passwords must match',
                            })}
            ...
            <ModalRadix className={s.emailSent} open={isOpen} onClose={() => {setIsOpen(false)}} modalTitle={'Email sent'}>
                <div>
